  ...
  return (
    <div className="glass-panel p-5 rounded-xl border border-glass-border flex flex-col gap-4 bg-white/[0.01]">
      <div className="flex justify-between items-center border-b border-glass-border pb-3">
        ...
        <span className="text-[9px] font-mono uppercase bg-vivid-cyan/10 text-vivid-cyan px-2 py-0.5 rounded border border-vivid-cyan/20">
          Diagnostics
        </span>
      </div>
      ...
      <div className="flex flex-col gap-3 font-mono text-xs">
        ...
        <div className="p-3 rounded bg-black/40 border border-glass-border/30 flex flex-col gap-2">
          ...
          {connected && walletAddress && (
            <>
              <div className="text-[10px] text-zinc-400 break-all select-all border-t border-glass-border/30 pt-1.5">
                Address: <span className="text-vivid-cyan font-bold">{walletAddress}</span>
              </div>
              <div className="flex justify-between border-t border-glass-border/30 pt-1.5 text-[11px]">
        ...
        <div className="p-3 rounded bg-black/40 border border-glass-border/30 flex flex-col gap-1.5">
          ...
          <span className="text-[9px] text-zinc-500 border-t border-glass-border/30 pt-1 mt-1 block">
        ...
        <div className="p-3 rounded bg-black/40 border border-glass-border/30 flex flex-col gap-2">
          ...
          {activeAgent ? (
            <div className="grid grid-cols-2 gap-y-2 gap-x-3 border-t border-glass-border/30 pt-2 text-[10px] text-zinc-400">
              <div>
                Vault Bal:{" "}
                <span className="text-white font-bold">
            ...
            <span className="text-[10px] text-zinc-500 border-t border-glass-border/30 pt-2">
