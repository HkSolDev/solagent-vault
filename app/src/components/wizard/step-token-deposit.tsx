  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 font-mono text-xs">
        ...
        <div className="flex flex-col gap-2 p-3.5 rounded bg-black/35 border border-glass-border/30">
          ...
          <div className="flex gap-2.5 mt-1">
            <input
              ...
              className="flex-1 bg-white/5 border border-glass-border px-3 py-2 rounded text-white font-mono text-[11px] focus:outline-none focus:border-electric-purple select-all"
              placeholder="Deploy a mint or enter an SPL token address"
            />
            <button
              onClick={onDeployCustomMint}
              disabled={actionLoading}
              className="px-4 py-2 rounded bg-zinc-800 hover:bg-zinc-700 border border-glass-border font-bold text-white transition-all cursor-pointer disabled:opacity-50 text-[10px]"
            >
              🚀 Deploy Mint
            </button>
          </div>
